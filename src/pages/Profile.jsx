...
import { User, Mail, MapPin, Package, Heart, LogOut, Settings, Bell, Shield } from 'lucide-react';
...
const Profile = () => {
  ...
  const stats = [
    { label: 'Orders', value: '12', icon: Package, color: 'bg-blue-50 text-blue-600' },
        ...
        <aside className="w-full lg:w-80 space-y-6">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm text-center">
            ...
            <div className="mt-6 pt-6 border-t border-gray-50 dark:border-gray-700">
               <Button onClick={() => dispatch(logout())} variant="outline" className="w-full text-red-600 border-red-100 hover:bg-red-50 gap-2">
          ...
          <nav className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
            {[
              ...
              <button key={item.label} className="w-full flex items-center gap-4 px-6 py-4 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-primary-600 transition-all border-b border-gray-50 dark:border-gray-700 last:border-0 font-medium">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-700 font-medium text-gray-400 italic">
                   Not set
                </div>
              </div>
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-700 font-medium">
                   <MapPin className="w-4 h-4 text-primary-600" /> New York, USA
                </div>
              </div>
            </div>
            <div className="pt-4 flex justify-end">
               <Button className="px-10 rounded-xl">Edit Profile</Button>
            </div>
          </div>
